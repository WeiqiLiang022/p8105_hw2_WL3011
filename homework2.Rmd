...
**results_df:**
*   Load results.csv;
*   Check for completeness of Star Baker and elimination outcomes for each episode.
*   Ensure that every episode has one Star Baker and, where applicable, one eliminated contestant.
...
```{r}
# Identify if any bakers in results are missing from the bakers dataset
